...
function check(lst1, lst2) {
    ...
    if ((lst1.includes(10) && lst2.includes(10)) || lst1.includes(11) && lst2.includes(11)) {
        if (lst1.includes(10)) {
    ...
    if (containsAnyNumberFrom17To25(lst1) && !containsAnyNumberFrom17To25(lst2) || !containsAnyNumberFrom17To25(lst1) && containsAnyNumberFrom17To25(lst2)){
        // Can not dry together
        instruction['dryCapatible'] = false
        instruction['dry'] = "You can not dry these two together!"
    }
    if ((lst1.includes(10) && !lst2.includes(10) || lst2.includes(10) &&!lst1.includes(10))) {
        instruction['washCapatible'] = false
        instruction['wash'] = "You can not wash these together"
    }
    if ((lst1.includes(11) && !lst2.includes(11) || lst2.includes(11) && !lst1.includes(11))) {
        instruction['washCapatible'] = false
        instruction['wash'] = "You can not wash these together"
    }
